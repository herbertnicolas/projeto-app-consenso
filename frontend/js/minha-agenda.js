...
function creatDiv(prestador,dia,hora,id) {
    ...
    img2.src = "../img/delete_FILL0_wght400_GRAD0_opsz48.png" //icone lixeira
    img2.onclick = deletaItem()
...
function deletaItem(){
    ...
    console.log("id serv: " + idServico)
    fetch("http://localhost:8080/servicos/{idServico}", {
        method: "DELETE",
        headers: {
